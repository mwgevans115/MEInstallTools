Function Get-ObjectsFromDatabase {
    ...
    ,ROUTINE_DEFINITION
    from sys.objects
    left outer join information_schema.routines on name = SPECIFIC_NAME AND SPECIFIC_SCHEMA=SCHEMA_NAME([schema_id])
"@
            $scriptCmd = { & $wrappedCmd @PSBoundParameters -Query $Query }
