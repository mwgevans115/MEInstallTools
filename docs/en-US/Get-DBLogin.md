...
```
Get-DBLogin [-ServerInstance <PSObject>] [-Database <String>] [-EncryptConnection] [-Username <String>]
 ...
 [-IgnoreProviderContext] [-OutputAs <OutputType>] [-Login <String>] [<CommonParameters>]
```

### ByConnectionString
```
Get-DBLogin [-QueryTimeout <Int32>] [-ErrorLevel <Int32>] [-SeverityLevel <Int32>] [-MaxCharLength <Int32>]
 [-MaxBinaryLength <Int32>] [-AbortOnError] [-DisableVariables] [-DisableCommands] [-Variable <String[]>]
 [-OutputSqlErrors <Boolean>] [-IncludeSqlUserErrors] [-OutputAs <OutputType>] -ConnectionString <String>
 [-Login <String>] [<CommonParameters>]
```
