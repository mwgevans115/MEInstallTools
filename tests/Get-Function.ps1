...
function Get-Function {
    ...
    #[OutputType([System.Management.Automation.Language.StatementAst[]])]
    [OutputType('System.Collections.Generic.IEnumerable`1[[System.Management.Automation.Language.Ast, System.Management.Automation, Version=3.0.0.0, Culture=neutral, PublicKeyToken=31bf3856ad364e35]]')]
    param(
    ...
    process {
        ...
        foreach ($aPath in $paths) {
            if ($pscmdlet.ShouldProcess($aPath, 'Operation')) {
                $Files = Get-ChildItem -Path $aPath -File
...
# (Get-ChildItem ..\src\Public\*.ps1 -Recurse -File | Get-Function)[0].Extent.File
